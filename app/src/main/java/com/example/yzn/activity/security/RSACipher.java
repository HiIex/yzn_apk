package com.example.yzn.activity.security;
...
public class RSACipher {
    ...
    public static byte[] encrypt(String publicKey, byte[] raw) throws Exception {
        ...
        return MyBase64.encodeBase64(b1);
    }
    ...
    public static String encrypt(String publicKey, String raw) throws Exception {
        ...
        Cipher cipher = Cipher.getInstance(Config.RSA_ALGORITHM);
        cipher.init(Cipher.ENCRYPT_MODE, key, new OAEPParameterSpec("SHA-256", "MGF1", MGF1ParameterSpec.SHA256, PSource.PSpecified.DEFAULT));
        byte[] b1 = cipher.doFinal(raw.getBytes());
        return byteToString(MyBase64.encodeBase64(b1));
    }
    ...
    public static byte[] decrypt(String privateKey, byte[] enc) throws Exception {
        ...
        return cipher.doFinal(MyBase64.decodeBase64(enc));
    }
    ...
    public static String decrypt(String privateKey, String enc) throws Exception {
        ...
        Cipher cipher = Cipher.getInstance(Config.RSA_ALGORITHM);
        cipher.init(Cipher.DECRYPT_MODE, key, new OAEPParameterSpec("SHA-256", "MGF1", MGF1ParameterSpec.SHA256, PSource.PSpecified.DEFAULT));
        return byteToString(cipher.doFinal(MyBase64.decodeBase64(enc.getBytes())));
    }
    ...
    public static PublicKey getPublicKey(String key) throws Exception {
        X509EncodedKeySpec keySpec = new X509EncodedKeySpec(MyBase64.decodeBase64(key.getBytes()));
    ...
    public static PrivateKey getPrivateKey(String key) throws Exception {
        PKCS8EncodedKeySpec keySpec = new PKCS8EncodedKeySpec(MyBase64.decodeBase64(key.getBytes()));
        KeyFactory keyFactory = KeyFactory.getInstance("RSA");
    ...
    public static String sign(String privateKey, byte[] content) {
        try {
            PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(MyBase64.decodeBase64(privateKey.getBytes()));
    ...
    public static boolean checkSign(String publicKey, byte[] content, String sign) {
        try {
            ...
            signature.update(content);
            return signature.verify(MyBase64.decode2(sign));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
